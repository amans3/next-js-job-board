...
export const handleJobExpiration = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    await step.run("update-job-status-in-Db", async () => {
    ...
    return { jobId, message: `Job marked as expired for jobId ${jobId}` };
  }
);
            ...
            await resend.emails.send({
              ...
              <div style="font-family: Arial,, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <div style="margin-top: 30px; text-align: center; margin-bottom: 20px;">
                 ...
                 style="background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-bottom: 20px;"                
                 >View More Jobs</a>
                </div>
              </div>
              `
